...
The executable generated takes in 2 arguments: a file path to a file with RYVM Assembly code and
a file path to the file compiled RYVM bytecode is inserted.
...
# Finally, the VM will automatically run the bytecode inside the output file.

./generated_bins/ryvm ./tests/programs/arith.ryasm ./tests/programs/arith.ryasm.ryc
```
